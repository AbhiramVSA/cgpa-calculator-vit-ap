    ...
    <html lang="en" suppressHydrationWarning className="scroll-smooth">
      <body className={`${inter.className} antialiased min-h-screen bg-background text-foreground`}>
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
          ...
          <main className="mx-auto min-h-[calc(100vh-140px)]">
            {children}
          </main>

          <footer className="border-t bg-background/80">
            <div className="mx-auto max-w-7xl px-4 py-8 grid gap-4 sm:grid-cols-2 items-center">
              <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} VIT-AP CGPA Calculator • Made with <span aria-hidden>❤️</span> by <a className="underline-offset-4 hover:underline" href="https://github.com/AbhiramVSA" target="_blank" rel="noopener noreferrer">Abhiram</a></p>
